  ...
  <div id="login">
    <div class="loginBox" @click="changeImage(3)">
      <div class="auth-form">
          ...
          <van-tab title="登录">
            ...
            <van-cell-group v-show="!isShowSMSLogin">
              ...
              <!-- 验证码接口 -->
                ...
                src="http://demo.itlike.com/web/xlmc/api/captcha" alt="captcha"
                @click.prevent="getCaptcha" ref="imgCaptcha" slot="button" />
              </van-field>
              <!-- 手机号快捷登录 -->
            </van-cell-group>
            <van-cell-group v-show="isShowSMSLogin">
        ...
        <!-- 底部声明 -->
        <p class="agreement">
          温馨提示：<br />未注册的手机号，登录时将自动注册，且代表同意<a
...
export default {
  data() {
    return {
      ...
      imageURL: require("./../../../static/myimg/xxxbbbttt.png"),
  ...
  methods: {
    ...
    changeImage(index) {
      if (index == 0) {
        this.imageURL = require("./../../../static/myimg/xxxbbbttt.png");
      } else if (index == 1) {
        this.imageURL = require("./../../../static/myimg/xxxbbbttt.png");
      } else {
        this.imageURL = require("./../../../static/myimg/xxxbbbttt.png");
...
#login {
  ...
  bottom: 0;
  /*背景图*/
  background: url("./../../../static/myimg/beijing.jpg");
