  ...
  <div class="wrapper">
    ...
    <div class="subTitleWrapper" ref="subTitleWrapper">
      <ul ref="ulContent">
        <li
          ...
          v-for="(detailItem,index) in right_data"
          :key="detailItem.id"
          ref="subTitle"
    ...
    <div class="showMenu" @click="menuClick" v-show="isShowDropMenu">
      <span class="downMenu" v-if="menuDown">
        ...
        >
          <path
            d="M511.31 989.39999995a61.19 61.19 0 0 1-43.25-17.79l-237.12-237.2a35 35 0 0 1 49.55-49.55l230.89 230.9 230.9-230.89a35 35 0 1 1 49.55 49.55L554.7 971.53999995a61.41 61.41 0 0 1-43.39 17.86z"
            fill="#8a8a8a"
            p-id="760"
          />
        </svg>
      ...
      <span class="upMenu" v-else>
        ...
        >
          <path
            d="M512.69 653.26666662a61.19 61.19 0 0 1 43.25 17.79l237.12 237.2a35 35 0 0 1-49.55 49.55l-230.89-230.9-230.9 230.89a35 35 0 1 1-49.55-49.55000001L469.3 671.12666662a61.41 61.41 0 0 1 43.39-17.86z"
            fill="#8a8a8a"
            p-id="760"
          />
        </svg>
    ...
    <section class="r_list" ref="r_list">
      <div ref="b">
        ...
        <div ref="good">
          ...
          <ul>
            <li v-for="(item,index) in right_data" :key="index" class="list">
              <div class="list_item flex">
                ...
                <div>
                  ...
                  <div class="iconCartWrapper" @click="addToCart3(item)">
...
<script>
  ...
  export default {
    ...
    methods: {
      addToCart3(goods) {
        alert(goods.id)
        PubSub.publish("homeAddToCart3",goods)
      },
      // 0.延展Vuex的方法
